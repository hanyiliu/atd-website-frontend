...
import { WhatWeOfferComponentMobile } from './what-we-offer-mobile.component';

// More on how to set up stories at: https://storybook.js.org/docs/writing-stories
const meta: Meta<WhatWeOfferComponentMobile> = {
  title: 'Components/WhatWeOffer',
  component: WhatWeOfferComponentMobile,
  tags: ['autodocs'],
  argTypes: {},
};

export default meta;
type Story = StoryObj<WhatWeOfferComponentMobile>;
