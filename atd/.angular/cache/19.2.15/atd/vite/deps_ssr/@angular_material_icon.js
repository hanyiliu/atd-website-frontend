...
var MatIcon = class _MatIcon {
  ...
  _currentIconFetch = import_rxjs9.Subscription.EMPTY;
  constructor() {
  ...
  _updateSvgIcon(rawName) {
    ...
    if (rawName) {
      ...
      this._currentIconFetch = this._iconRegistry.getNamedSvgIcon(iconName, namespace).pipe((0, import_operators7.take)(1)).subscribe((svg) => this._setSvgElement(svg), (err) => {
